...
class WeaponTest extends munit.FunSuite {
  ...
  test("Weapon equality") {
    val weapon1 = new Weapon("Sword", 50, 10.0, null)
    val weapon2 = new Weapon("Sword", 50, 10.0, null)
    val weapon3 = new Weapon("Axe", 60, 12.0, null)
  ...
  test("Weapon toString") {
    val weapon = new Weapon("Sword", 50, 10.0, null)
